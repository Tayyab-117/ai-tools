...
export default function Footer(){
  return (<footer className="border-t mt-10 bg-white"><div className="container py-10">
    <div className="grid gap-6 md:grid-cols-4">
      <div><div className="text-lg font-semibold">🤖 FreeAIHub</div><p className="mt-1 text-sm text-gray-600">AI‑flavored, privacy‑first tools.</p></div>
    ...
    <div className="mt-8 flex items-center justify-between border-t pt-6 text-xs text-gray-500">
      <span>© {new Date().getFullYear()} FreeAIHub.</span><span>No logins. Local processing.</span></div></div></footer>)
}
