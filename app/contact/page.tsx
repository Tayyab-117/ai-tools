...
export default function Contact(){
  ...
  return (<div className="container py-10"><h1 className="text-2xl font-semibold mb-2">Contact</h1>
    <form onSubmit={submit} className="card p-4 max-w-xl space-y-3"><input name="name" className="input" placeholder="Your name" required/><input name="email" type="email" className="input" placeholder="Your email" required/><textarea name="message" className="textarea" placeholder="How can we help?" required/><button className="btn-primary" type="submit">Send</button>{status && <div className="text-sm text-gray-600">{status}</div>}</form>
  </div>)
}
