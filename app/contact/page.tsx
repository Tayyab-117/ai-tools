...
export default function Contact(){
  ...
  const onSubmit=async(e:React.FormEvent<HTMLFormElement>)=>{
    ...
    setStatus('Sending...'); try{ const res=await fetch(endpoint,{method:'POST',body:data}); if(res.ok){ setStatus('Thanks! We received your message.'); form.reset() } else setStatus('Failed to send. Please try again later.') }catch{ setStatus('Network error. Please try again later.') }
  }
