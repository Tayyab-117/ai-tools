...
import ToolShell from '../../components/ToolShell' // or '../../../components/ToolShell'
...
export function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  if (!t) return {}
  return { title: `${t.name} — FreeAIHub`, description: t.tagline }
}
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <aside className="space-y-4">
          <div className="card p-4">
            ...
            <p className="mt-2 text-sm text-gray-700">{tool.seo.longDescription}</p>
          </div>
          ...
          {tool.seo.useCases && tool.seo.useCases.length > 0 && (
            <div className="card p-4">
