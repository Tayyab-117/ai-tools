...
export default function TextDiff(){ const [a,setA]=useState('hello\nworld'), [b,setB]=useState('hello\nthere'); const rows=diff(a,b)
  return (<div className="space-y-3"><div className="grid gap-4 md:grid-cols-2"><textarea className="textarea" value={a} onChange={e=>setA(e.target.value)}/><textarea className="textarea" value={b} onChange={e=>setB(e.target.value)}/></div>
